...
SelfSection:AddToggle({text = "Fly", callback = function(state)
    if state then
...
SelfSection:AddButton({text = "tpwalk", callback = function()
	tpwalking = false
...
EnemySection:AddSlider({text = "Hitbox size", min = 1, max = 30, value = 1, callback = function(s)
_G.HeadSize = s
_G.Disabled = true
