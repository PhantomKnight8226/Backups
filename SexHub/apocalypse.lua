...
EnemySection:AddSlider({text = "Bighead size", min = 1, max = 30, value = 1, callback = function(s)
_G.HeadSize = s
_G.Disabled = true
...
MovementSection:AddSlider({text = "Jump Power value", min = 50, max = 500, value = 50, callback = function(v)
    getgenv().JP = true
    getgenv().JumpPower = v
...
ESPSection:AddToggle({text = "Apoc2 esp", callback = function()
