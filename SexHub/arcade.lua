...
local ExtraSection = SettingsColumn:AddSection("ExtraSection Might Kick/Ban");
local AimlockSection = SettingsColumn2:AddSection("Aimlock");

SilentSection:AddToggle({text = "Silent Aim", callback = function()
getgenv().Settings = {
   Fov = 300,
   Hitbox = "Head",
   FovCircle = false,
...
SilentSection:AddSlider({text = "Silent aim offset", min = 0, max = 150, value = 50, callback = function(s)
end});
...
AimlockSection:AddSlider({text = "Fov Circle", min = 0, max = 500, value = 0, callback = function(c)
	_G.CircleRadius = c
end});

--// Ragemode \\--
local SettingsTab = library:AddTab("Ragemode"); 
local SettingsColumn = SettingsTab:AddColumn(); 
local SettingsColumn2 = SettingsTab:AddColumn(); 
local SelfSection = SettingsColumn:AddSection("Self mods"); 
local EnemySection = SettingsColumn2:AddSection("Enemy mods");
local MovementSection = SettingsColumn2:AddSection("Movement");

SelfSection:AddToggle({text = "Bhop", callback = function(state)
if state then
    getgenv().Bhop = true
    repeat wait()
...
SelfSection:AddToggle({text = "Infinite jump", callback = function(state)
    if state then
...
SelfSection:AddToggle({text = "Body chams", callback = function()
...
EnemySection:AddToggle({text = "Hitbox extender", callback = function()
end});

EnemySection:AddSlider({text = "Hitbox size", min = 1, max = 10, value = 1, callback = function()
end});

EnemySection:AddToggle({text = "Bighead", callback = function()
end});

EnemySection:AddSlider({text = "Bighead size", min = 1, max = 5, value = 1, callback = function(s)

end});

MovementSection:AddToggle({text = "Omni sprint", callback = function()
end});

MovementSection:AddSlider({text = "Omni sprint value", min = 17, max = 40, value = 17, callback = function(s)
   _G.Speed = s
...
MovementSection:AddToggle({text = "MUI dash", callback = function()
end});

MovementSection:AddToggle({text = "Click tp", callback = function()
...
ESPSection:AddToggle({text = "Draw ESP", callback = function(state)
    if state then
...
ESPSection:AddToggle({text = "Draw Boxes", callback = function(state)
if state then
...
ESPSection:AddToggle({text = "Draw Tracers", callback = function(state)
    if state then
        local function API_Check()
            if Drawing == nil then
                return "No"
...
ESPSection:AddColor({text = "ESP Color", flag = "Sets the ESP Color", color = Color3.fromRGB(128, 234, 255), callback = function(color)
    _G.TracerColor = color
    _G.LineColor = color
    BoneESP_Color = color
end});

MapSection:AddToggle({text = "Fullbright", callback = function()
...
MapSection:AddToggle({text = "High graphics", callback = function()
end});
...
setclipboard("discord.gg/a7AEfZDCct")
end})
