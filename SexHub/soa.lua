...
local AimlockSection = SettingsColumn:AddSection("Aimlock");

--// ExtraSection \\--
AimlockSection:AddToggle({text = "Aimlock (soon)", callback = function(state)
  if state then
...
local MovementSection = SettingsColumn:AddSection("Movement");
...
EnemySection:AddToggle({text = "Bighead", callback = function(state)
	if state then
	_G.Disabled = true
	else
	_G.Disabled = false
...
EnemySection:AddSlider({text = "Bighead size", min = 1, max = 30, value = 1, callback = function(state)
_G.HeadSize = state
_G.Disabled = true
...
MovementSection:AddToggle({text = "Jump Power", callback = function()
	if state then
		getgenv().JP = true
	else
		getgenv().JP = true
...
MovementSection:AddSlider({text = "Jump Power value", min = 10, max = 500, value = 10, callback = function(v)
    getgenv().JP = true
    getgenv().JumpPower = v
